...
pdf("figures/example_dynamics.pdf", width=6, height=4, colormodel = "cmyk", useDingbats = FALSE)
  ...
  par(mar=c(3,4.2,1,4.8), oma=c(1,0,0,0.5))
  ...
  mtext(expression(paste(italic(x), "(", italic(t), ")")), 2, line=2.5, cex=1.5, adj=0.55)
  ...
  text(4.73, -0.29, expression(paste(invariance^-1)), cex=1.5, xpd=NA,
